...
class OAuthService {
  constructor(private client: ReturnType<typeof axios.create>) {
    if (ENV.oAuthServerUrl) {
      ...
      // Legacy Manus OAuth is optional. The AI server authenticates via Firebase,
      // so an unset OAUTH_SERVER_URL is expected and not an error.
      console.warn(
        "[OAuth] OAUTH_SERVER_URL not set — legacy Manus OAuth endpoints are disabled (safe to ignore for the AI server).",
      );
    }
  }
